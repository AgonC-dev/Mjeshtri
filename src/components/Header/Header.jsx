...
return (
  ...
  {/* ADMIN LINK: Added hideOnMobile class to text only */}
  {user && user.uid === ADMIN_UID && (
    <Link to="/admin" className={styles.adminLink}>
      ⚙️ <span className={styles.hideOnMobile}>Paneli Admin</span>
    </Link>
  )}
  ...
  {user ? (
            ...
            {profileStrength === -1 ? (
              <div className={styles.criticalWarning}>
                ...
                <p className={styles.warningText}>
                  Mungon kategoria, emri ose qyteti. Klientët nuk mund t'ju gjejnë!
                </p>
                <Link
                  to="/dashboard"
    ...
    /* LOGGED OUT VIEW - Added wrapper for easier CSS spacing */
    <div className={styles.loggedOutActions}>
      ...
      {/* Hidden on mobile to make room for Login and Heart */}
      ...
      >
        {/* NEW: Icon that only shows on mobile */}
        <span className={styles.mobileLoginIcon}>
          <User size={20}  color="#ffffff" strokeWidth={2.5}/>
        </span>
        {/* OLD: Text that hides on mobile */}
        <span className={styles.hideOnMobile}>Kyqu si mjeshtër</span>
      </NavLink>
